...
LEECH_UNZIP_COMMAND = os.environ.get("LEECH_UNZIP_COMMAND", "extract@PopCornleech_bot") + BOT
LEECH_ZIP_COMMAND = os.environ.get("LEECH_ZIP_COMMAND", "zip@PopCornleech_bot") + BOT
