...
LEECH_COMMAND = os.environ.get("LEECH_COMMAND", "leechasfile@PopCornsleech_bot") + BOT
LEECH_UNZIP_COMMAND = os.environ.get("LEECH_UNZIP_COMMAND", "leechunzipasfile@PopCornsleech_bot") + BOT
LEECH_ZIP_COMMAND = os.environ.get("LEECH_ZIP_COMMAND", "leechzipasfile@PopCornsleech_bot") + BOT
...
YTDL_COMMAND = os.environ.get("YTDL_COMMAND", "ytdlasfile@PopCornsleech_bot") + BOT
...
CANCEL_COMMAND_G = os.environ.get("CANCEL_COMMAND_G", "cancel@PopCornsleech_bot")
GET_SIZE_G = os.environ.get("GET_SIZE_G", "getseeeedize")
STATUS_COMMAND = os.environ.get("STATUS_COMMAND", "status@PopCornsleech_bot") + BOT
SAVE_THUMBNAIL = os.environ.get("SAVE_THUMBNAIL", "savethum@PopCornsleech_bot") + BOT
CLEAR_THUMBNAIL = os.environ.get("CLEAR_THUMBNAIL", "clearthumb@PopCornsleech_bot") + BOT
UPLOAD_AS_DOC = os.environ.get("UPLOAD_AS_DOC", "False")
PYTDL_COMMAND = os.environ.get("PYTDL_COMMAND", "pytdlasfile@PopCornsleech_bot") + BOT
...
UPLOAD_COMMAND = os.environ.get("UPLOAD_COMMAND", "uplooad@PopCornsleech_bot")
RENEWME_COMMAND = os.environ.get("RENEWME_COMMAND", "renewme@PopCornsleech_bot")
