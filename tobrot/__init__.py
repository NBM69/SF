...
LEECH_COMMAND = os.environ.get("LEECH_COMMAND", "leech@PopCornleech_bot") + BOT
LEECH_UNZIP_COMMAND = os.environ.get("LEECH_UNZIP_COMMAND", "leechunzip@PopCornleech_bot") + BOT
LEECH_ZIP_COMMAND = os.environ.get("LEECH_ZIP_COMMAND", "leechzip@PopCornleech_bot") + BOT
...
YTDL_COMMAND = os.environ.get("YTDL_COMMAND", "ytdl@PopCornleech_bot") + BOT
...
CANCEL_COMMAND_G = os.environ.get("CANCEL_COMMAND_G", "cancel@PopCornleech_bot")
GET_SIZE_G = os.environ.get("GET_SIZE_G", "getseeeedize")
STATUS_COMMAND = os.environ.get("STATUS_COMMAND", "status@PopCornleech_bot") + BOT
SAVE_THUMBNAIL = os.environ.get("SAVE_THUMBNAIL", "savethumb@PopCornleech_bot") + BOT
CLEAR_THUMBNAIL = os.environ.get("CLEAR_THUMBNAIL", "clearthumb@PopCornleech_bot") + BOT
UPLOAD_AS_DOC = os.environ.get("UPLOAD_AS_DOC", "False")
PYTDL_COMMAND = os.environ.get("PYTDL_COMMAND", "pytdl@PopCornleech_bot") + BOT
...
UPLOAD_COMMAND = os.environ.get("UPLOAD_COMMAND", "uplooad@PopCornleech_bot")
RENEWME_COMMAND = os.environ.get("RENEWME_COMMAND", "renewme@PopCornleech_bot")
