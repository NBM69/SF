...
LEECH_UNZIP_COMMAND = os.environ.get("LEECH_UNZIP_COMMAND", "extractasfile@PopCornsleech_bot") + BOT
LEECH_ZIP_COMMAND = os.environ.get("LEECH_ZIP_COMMAND", "zipasfile@PopCornsleech_bot") + BOT
...
SAVE_THUMBNAIL = os.environ.get("SAVE_THUMBNAIL", "savethumb1@PopCornsleech_bot") + BOT
CLEAR_THUMBNAIL = os.environ.get("CLEAR_THUMBNAIL", "clearthumb1@PopCornsleech_bot") + BOT
